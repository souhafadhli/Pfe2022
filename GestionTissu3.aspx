<%@ Page Title="" Language="C#" MasterPageFile="~/Visiteur.Master" AutoEventWireup="true" CodeBehind="GestionTissu3.aspx.cs" Inherits="WebApplication.GestionTissu3" %>
        ...
        <table class="table " style="width:10px">
         <h1 style="font-size: 25px" >Défauts Des Tissus</h1>
            ...
            <tr>
                ...
                <td>  <asp:DropDownList ID="codefaut" runat="server"  DataSourceID="SqlDataSource2" DataTextField="code" DataValueField="code"  Width="100px" style="border:none" AutoPostBack="true" OnSelectedIndexChanged="codefaut_SelectedIndexChanged"></asp:DropDownList>
