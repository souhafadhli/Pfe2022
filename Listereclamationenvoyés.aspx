<%@ Page Title="" Language="C#" MasterPageFile="~/Visiteur.Master" AutoEventWireup="true" CodeBehind="Listereclamationenvoyés.aspx.cs" Inherits="WebApplication.Listereclamationenvoyés" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Liste Des Récalamtions Envoyés</h2>
					</div>
					<div class="col-sm-6">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MICConnectionString %>"  SelectCommand="SELECT * FROM [dbo].[Reclamation] a , [dbo].Utilisateurs b where  b.nom=a.NomVisiteur"></asp:SqlDataSource> 
    ...
    <asp:GridView ID="GridView1" class="table table-striped table-hover" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="Id" ForeColor="#333333" GridLines="None">
        <Columns>
